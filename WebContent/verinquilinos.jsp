...
<html>
<head>
<title>HOTEL DATABASE - Inquilinos</title>
<meta charset="utf-8">
...
<% 
String query="SELECT c.nombre, c.apellidos, ca.idHabitacion, ca.fechaSalida FROM ClientesActuales ca JOIN clientes c ON (ca.idCliente = c.idCliente)";
beanDB basededatos = new beanDB();
String [][] tablares = basededatos.resConsultaSelectA3(query);
%> 
<table>
<tr>
<th>Nombre</th><th>Apellidos</th><th>Habitación</th>
</tr>
